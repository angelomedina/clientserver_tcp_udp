...
def appupload():
    ...
    print('server -u listening: '+ host +' '+str(port))
...
def appdownload():
    ...
    print('server -d listening: '+ host +' '+str(port))
...
if __name__=='__main__':
    t1 = threading.Thread(target = applist)
    t2 = threading.Thread(target = appupload)
    t3 = threading.Thread(target = appdownload)
